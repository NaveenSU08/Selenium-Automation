...
public class BasicAssigTNG6 {
	...
	private static void modifyProject(String mprojname)
	{
		try
		{
			...
			Thread.sleep(1000);
			oBrowser.findElement(By.xpath("//*[@id='taskListBlock']/div[4]/div[1]/div[2]/div[2]/div/div[2]/input")).sendKeys(mprojname);
			Thread.sleep(1000);
			oBrowser.findElement(By.xpath("//*[@id='cpTreeBlock']/div[2]/div[2]/div/div[2]/div/div[1]/div[2]/div[3]/div[3]")).click();
			Thread.sleep(1000);
		}catch(Exception e)
	...
	private static void closeApplication()
	{
		...
		{
			oBrowser.quit();
			System.out.println("---------------------END OF BASIC SCENARIO_6------------------");
		}catch(Exception e)
		{
			e.printStackTrace();
		}
    ...
    {
    	return new Object[] {"Modify Project"};
    }
}
